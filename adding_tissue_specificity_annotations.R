...
HPA_exp_df <- read.table("/diskmnt/Datasets/mmy_scratch/lyao/MMY/Analysis/cell_surface_markers/Results/V8/Union_discovery/HPA_normal_tissue.tsv",header=T,fill=T)

tissue_type_match <- read.table("/diskmnt/Datasets/mmy_scratch/lyao/MMY/Analysis/cell_surface_markers/Data/HPA_Tissue_type_matching.txt",sep="\t",header=T)
