...
CELL_TYPE=Plasma
perl ${SCRIPT_DIR}/step1.get_surface_genes_expression_data.pl ${OUT_DIR}/${CELL_TYPE}_specific_DEG_with_surface_annotations_from_3DB_gene_list.txt ${GTEX_DIR} > ${OUT_DIR}/GTEX_expression_matrix_subset_tumor_cells_DEG.txt
